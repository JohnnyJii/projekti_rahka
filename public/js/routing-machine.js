    ...
    function(_dereq_, module, exports) {
      ...
      polyline.encode = function(coordinates, precision) {
        ...
        var factor = Math.pow(10, precision || 5),
            output = encode(coordinates[0][0], 0, factor) +
      ...
      module.exports = function(version) {
        ...
        return {
          capitalizeFirstLetter: function(language, string) {
            return string.charAt(0).toLocaleUpperCase(language) +
                string.slice(1);
          },
          ...
          laneConfig: function(step) {
            ...
            if (!step.intersections ||
                !step.intersections[0].lanes) throw new Error(
                'No lanes object');
          ...
          getWayName: function(language, step, options) {
            ...
            if (typeof step !== 'object') throw new Error(
                'step must be an Object');
            if (!language) throw new Error('No language code provided');
            if (!Array.isArray(classes)) throw new Error(
                'classes must be an Array or undefined');
            ...
            if (name && ref && name !== ref && !wayMotorway) {
              ...
              wayName = options && options.formatToken ?
          ...
          compile: function(language, step, opts) {
            if (!language) throw new Error('No language code provided');
            if (languages.supportedCodes.indexOf(language) ===
                -1) throw new Error('language code ' + language +
                ' not loaded');
            ...
            if (instructions[language][version].modes[mode]) {
              ...
              if (instructions[language][version][type][modifier] &&
                  !omitSide) {
            ...
            switch (type) {
              case 'use lane':
                laneInstruction = instructions[language][version].constants.lanes[this.laneConfig(
                    step)];
                if (!laneInstruction) {
              ...
              case 'rotary':
              case 'roundabout':
                if (step.rotary_name && step.maneuver.exit &&
            ...
            var instruction;
            if (step.destinations && step.exits &&
            ...
            var destinations = step.destinations &&
                step.destinations.split(': ');
            var destinationRef = destinations && destinations[0].split(',')[0];
            var destination = destinations && destinations[1] &&
            ...
            var nthWaypoint = options.legIndex >= 0 &&
            ...
            var replaceTokens = {
              ...
              'direction': this.directionFromDegree(language,
          ...
          grammarize: function(language, name, grammar) {
            ...
            if (name && grammar && grammars && grammars[language] &&
          ...
          tokenize: function(language, instruction, tokens, options) {
            ...
            var output = instruction.replace(/\{(\w+)(?::(\w+))?\}/g,
        ...
        'v5': {
          'accusative': [
            ...
            [
              ...
              ' $1юю магистраль '],
            [
              '^ (\\S+)ая (\\S+)ая [Мм]агистраль ',
              ' $1ую $2ую магистраль '],
            [
              '^ (\\d+)-я (\\S+)ая [Мм]агистраль ',
              ' $1-ю $2ую магистраль '],
            [
              '^ [Мм]агистраль ',
              ' магистраль '],
            ...
            [
              '^ (\\S+)ая ([Аа]вто)?[Дд]орога ',
              ' $1ую $2дорогу '],
            [
              '^ (\\S+)ья ([Аа]вто)?[Дд]орога ',
              ' $1ью $2дорогу '],
            [
              '^ (\\S+)яя ([Аа]вто)?[Дд]орога ',
              ' $1юю $2дорогу '],
            [
          ...
          'dative': [
            ...
            [
              ...
              ' $1ому $2у бульвару '],
            [
              '^ (\\d+)-й (\\S+н)ий [Бб]ульвар ',
              ' $1-му $2ему бульвару '],
            [
              '^ (\\d+)-й (\\S+)[иоы]й [Бб]ульвар ',
              ' $1-му $2ому бульвару '],
            [
              '^ (\\d+)-й (\\S+[иы]н) [Бб]ульвар ',
              ' $1-му $2у бульвару '],
            [
              '^ [Бб]ульвар ',
              ' бульвару '],
            ...
            [
              ...
              ' $1у заезду '],
            [
              '^ (\\S+)[иоы]й (\\S+н)ий [Зз]аезд ',
              ' $1ому $2ему заезду '],
            [
              '^ (\\S+н)ий (\\S+)[иоы]й [Зз]аезд ',
              ' $1ему $2ому заезду '],
            [
              '^ (\\S+)[иоы]й (\\S+)[иоы]й [Зз]аезд ',
              ' $1ому $2ому заезду '],
            [
              '^ (\\S+)[иоы]й (\\S+[еёо]в) [Зз]аезд ',
              ' $1ому $2у заезду '],
            [
              '^ (\\S+)[иоы]й (\\S+[иы]н) [Зз]аезд ',
              ' $1ому $2у заезду '],
            [
              '^ (\\d+)-й (\\S+н)ий [Зз]аезд ',
              ' $1-му $2ему заезду '],
            ...
            [
              ...
              ' $1у мосту '],
            [
              '^ (\\S+)[иоы]й (\\S+н)ий [Мм]ост ',
              ' $1ому $2ему мосту '],
            [
              '^ (\\S+н)ий (\\S+)[иоы]й [Мм]ост ',
              ' $1ему $2ому мосту '],
            [
              '^ (\\S+)[иоы]й (\\S+)[иоы]й [Мм]ост ',
              ' $1ому $2ому мосту '],
            [
              '^ (\\S+)[иоы]й (\\S+[еёо]в) [Мм]ост ',
              ' $1ому $2у мосту '],
            [
              '^ (\\S+)[иоы]й (\\S+[иы]н) [Мм]ост ',
              ' $1ому $2у мосту '],
            [
              '^ (\\d+)-й [Мм]ост ',
              ' $1-му мосту '],
            ...
            [
              ...
              ' $1у парку '],
            [
              '^ (\\S+)[иоы]й (\\S+н)ий [Пп]арк ',
              ' $1ому $2ему парку '],
            [
              '^ (\\S+н)ий (\\S+)[иоы]й [Пп]арк ',
              ' $1ему $2ому парку '],
            [
              '^ (\\S+)[иоы]й (\\S+)[иоы]й [Пп]арк ',
              ' $1ому $2ому парку '],
            [
              '^ (\\S+)[иоы]й (\\S+[иы]н) [Пп]арк ',
              ' $1ому $2у парку '],
            [
              '^ (\\d+)-й (\\S+н)ий [Пп]арк ',
              ' $1-му $2ему парку '],
            ...
            [
              ...
              ' $1-му переулку '],
            [
              '^ (\\d+)-й (\\S+н)ий [Пп]ереулок ',
              ' $1-му $2ему переулку '],
            [
              '^ (\\d+)-й (\\S+)[иоы]й [Пп]ереулок ',
              ' $1-му $2ому переулку '],
            [
              '^ (\\d+)-й (\\S+[еёо]в) [Пп]ереулок ',
              ' $1-му $2у переулку '],
            [
              '^ (\\d+)-й (\\S+[иы]н) [Пп]ереулок ',
              ' $1-му $2у переулку '],
            [
              '^ [Пп]ереулок ',
              ' переулку '],
            ...
            [
              ...
              ' $1у проезду '],
            [
              '^ (\\S+)[иоы]й (\\S+н)ий [Пп]роезд ',
              ' $1ому $2ему проезду '],
            [
              '^ (\\S+н)ий (\\S+)[иоы]й [Пп]роезд ',
              ' $1ему $2ому проезду '],
            [
              '^ (\\S+)[иоы]й (\\S+)[иоы]й [Пп]роезд ',
              ' $1ому $2ому проезду '],
            [
              '^ (\\S+)[иоы]й (\\S+[еёо]в) [Пп]роезд ',
              ' $1ому $2у проезду '],
            [
              '^ (\\S+)[иоы]й (\\S+[иы]н) [Пп]роезд ',
              ' $1ому $2у проезду '],
            [
              '^ (\\d+)-й [Пп]роезд ',
              ' $1-му проезду '],
            [
              ...
              ' $1-му $2ему проезду '],
            [
              '^ (\\d+)-й (\\S+)[иоы]й [Пп]роезд ',
              ' $1-му $2ому проезду '],
            [
              '^ (\\d+)-й (\\S+[еёо]в) [Пп]роезд ',
              ' $1-му $2у проезду '],
            [
              '^ (\\d+)-й (\\S+[иы]н) [Пп]роезд ',
              ' $1-му $2у проезду '],
            ...
            [
              ...
              ' $1у спуску '],
            [
              '^ (\\S+)[иоы]й (\\S+н)ий [Сс]пуск ',
              ' $1ому $2ему спуску '],
            [
              '^ (\\S+н)ий (\\S+)[иоы]й [Сс]пуск ',
              ' $1ему $2ому спуску '],
            [
              '^ (\\S+)[иоы]й (\\S+)[иоы]й [Сс]пуск ',
              ' $1ому $2ому спуску '],
            [
              '^ (\\S+)[иоы]й (\\S+[еёо]в) [Сс]пуск ',
              ' $1ому $2у спуску '],
            [
              '^ (\\S+)[иоы]й (\\S+[иы]н) [Сс]пуск ',
              ' $1ому $2у спуску '],
            [
              '^ (\\d+)-й (\\S+н)ий [Сс]пуск ',
              ' $1-му $2ему спуску '],
            ...
            [
              ...
              ' $1у съезду '],
            [
              '^ (\\S+)[иоы]й (\\S+н)ий [Сс]ъезд ',
              ' $1ому $2ему съезду '],
            [
              '^ (\\S+н)ий (\\S+)[иоы]й [Сс]ъезд ',
              ' $1ему $2ому съезду '],
            [
              '^ (\\S+)[иоы]й (\\S+)[иоы]й [Сс]ъезд ',
              ' $1ому $2ому съезду '],
            [
              '^ (\\S+)[иоы]й (\\S+[иы]н) [Сс]ъезд ',
              ' $1ому $2у съезду '],
            [
              '^ (\\d+)-й (\\S+н)ий [Сс]ъезд ',
              ' $1-му $2ему съезду '],
            ...
            [
              ...
              ' $1у тракту '],
            [
              '^ (\\S+)[иоы]й (\\S+н)ий [Тт]ракт ',
              ' $1ому $2ему тракту '],
            [
              '^ (\\S+н)ий (\\S+)[иоы]й [Тт]ракт ',
              ' $1ему $2ому тракту '],
            [
              '^ (\\S+)[иоы]й (\\S+)[иоы]й [Тт]ракт ',
              ' $1ому $2ому тракту '],
            [
              '^ (\\S+)[иоы]й (\\S+[еёо]в) [Тт]ракт ',
              ' $1ому $2у тракту '],
            [
              '^ (\\S+)[иоы]й (\\S+[иы]н) [Тт]ракт ',
              ' $1ому $2у тракту '],
            [
              '^ (\\d+)-й (\\S+н)ий [Тт]ракт ',
              ' $1-му $2ему тракту '],
            ...
            [
              ...
              ' $1у тупику '],
            [
              '^ (\\S+)[иоы]й (\\S+н)ий [Тт]упик ',
              ' $1ому $2ему тупику '],
            [
              '^ (\\S+н)ий (\\S+)[иоы]й [Тт]упик ',
              ' $1ему $2ому тупику '],
            [
              '^ (\\S+)[иоы]й (\\S+)[иоы]й [Тт]упик ',
              ' $1ому $2ому тупику '],
            [
              '^ (\\S+)[иоы]й (\\S+[еёо]в) [Тт]упик ',
              ' $1ому $2у тупику '],
            [
              '^ (\\S+)[иоы]й (\\S+[иы]н) [Тт]упик ',
              ' $1ому $2у тупику '],
            [
              '^ (\\d+)-й [Тт]упик ',
              ' $1-му тупику '],
            ...
            [
              '^ (\\S+[ео])е ([Пп]олу)?[Кк]ольцо ',
              ' $1му $2кольцу '],
            [
              '^ (\\S+ье) ([Пп]олу)?[Кк]ольцо ',
              ' $1му $2кольцу '],
            [
          ...
          module.exports = L.Class.extend({
            ...
            initialize: function(elem, callback, context, options) {
              ...
              this._autocomplete = options.autocompleteFn ?
                  L.Util.bind(options.autocompleteFn,
                      options.autocompleteContext) :
                  null;
              this._selectFn = L.Util.bind(callback, context);
              this._container = L.DomUtil.create('div',
                  'leaflet-routing-geocoder-result');
              this._resultTable = L.DomUtil.create('table', '',
                  this._container);

              // TODO: looks a bit like a kludge to register same for input and keypress -
              // browsers supporting both will get duplicate events; just registering
              // input will not catch enter, though.
              L.DomEvent.addListener(this._elem, 'input', this._keyPressed,
                  this);
              L.DomEvent.addListener(this._elem, 'keypress', this._keyPressed,
                  this);
              L.DomEvent.addListener(this._elem, 'keydown', this._keyDown,
                  this);
            ...
            _setResults: function(results) {
              ...
              for (i = 0; i < results.length; i++) {
                ...
                L.DomEvent.addListener(td, 'mousedown',
                    L.DomEvent.preventDefault);
                L.DomEvent.addListener(td, 'click',
              ...
              if (!i) {
                ...
                td = L.DomUtil.create('td',
                    'leaflet-routing-geocoder-no-results', tr);
            ...
            _keyPressed: function(e) {
              ...
              if (this._isOpen && e.keyCode === 13 && this._selection) {
                index = parseInt(
                    this._selection.getAttribute('data-result-index'), 10);
            ...
            _select: function(dir) {
              ...
              if (sel) {
                L.DomUtil.removeClass(sel.firstChild,
              ...
              if (sel) {
                L.DomUtil.addClass(sel.firstChild,
                    'leaflet-routing-geocoder-selected');
                this._selection = sel;
              }
            },
            ...
            _unselect: function() {
              if (this._selection) {
                L.DomUtil.removeClass(this._selection.firstChild,
                    'leaflet-routing-geocoder-selected');
              }
              delete this._selection;
            },
        ...
        (function() {
          ...
          module.exports = Itinerary.extend({
            ...
            onAdd: function(map) {
              ...
              if (this._plan.options.geocoder) {
                container.insertBefore(this._plan.createGeocoders(),
            ...
            spliceWaypoints: function() {
              var removed = this._plan.spliceWaypoints.apply(this._plan,
                  arguments);
              return removed;
            },
            ...
            _routeSelected: function(e) {
              ...
              if (this.options.waypointMode === 'snap') {
                this._plan.off('waypointschanged', this._onWaypointsChanged,
                    this);
                this.setWaypoints(route.waypoints);
                this._plan.on('waypointschanged', this._onWaypointsChanged,
                    this);
              }
            },
            ...
            _updateLines: function(routes) {
              ...
              this._alternatives = [];
              if (routes.alternatives) routes.alternatives.forEach(
                  function(alt, i) {
            ...
            _updateLineCallback: function(err, routes) {
              if (!err) {
                routes = routes.slice();
                var selected = routes.splice(this._selectedRoute.routesIndex,
                    1)[0];
                this._updateLines({
                  route: selected,
            ...
            route: function(options) {
              ...
              if (this._plan.isReady()) {
                ...
                this._pendingRequest = this._router.route(wps,
                    function(err, routes) {
                      this._pendingRequest = null;
          ...
          typeof self !== 'undefined' ?
              ...
              typeof window !== 'undefined' ?
                  window :
                  {});
    }, {'./itinerary': 55, './line': 56, './osrm-v1': 59, './plan': 60}], 50: [
    function(_dereq_, module, exports) {
      (function(global) {
        (function() {
          'use strict';
    ...
    function(_dereq_, module, exports) {
      (function(global) {
        (function() {
          ...
          module.exports = L.Class.extend({
            includes: ((typeof L.Evented !== 'undefined' &&
                L.Evented.prototype) || L.Mixin.Events),
            ...
            options: {
                ...
                var container = L.DomUtil.create('div',
                    ...
                    remove = options.addWaypoints ?
                        L.DomUtil.create('span',
                            'leaflet-routing-remove-waypoint', container) :
                        undefined;
              ...
              geocoderPlaceholder: function(
                  i, numberWaypoints, geocoderElement) {
                var l = new Localization(
                    geocoderElement.options.language).localize('ui');
                return i === 0 ?
                    l.startPlaceholder :
                    (i < numberWaypoints - 1 ?
              ...
              waypointNameFallback: function(latLng) {
                var ns = latLng.lat < 0 ? 'S' : 'N',
                    ew = latLng.lng < 0 ? 'W' : 'E',
                    lat = (Math.round(Math.abs(latLng.lat) * 10000) /
                        10000).toString(),
                    lng = (Math.round(Math.abs(latLng.lng) * 10000) /
                        10000).toString();
            ...
            initialize: function(wp, i, nWps, options) {
              ...
              geocoderInput.setAttribute('placeholder',
          ...
          typeof self !== 'undefined' ?
              ...
              typeof window !== 'undefined' ?
                  window :
                  {});
    }, {'./autocomplete': 48, './localization': 57}], 53: [
    function(_dereq_, module, exports) {
      (function(global) {
        var L = (typeof window !== 'undefined' ?
            window['L'] :
        ...
        (function() {
          ...
          module.exports = L.Class.extend({
            ...
            createContainer: function(className) {
              ...
              L.DomUtil.create('col', 'leaflet-routing-instruction-icon',
                  colgroup);
              L.DomUtil.create('col', 'leaflet-routing-instruction-text',
                  colgroup);
              L.DomUtil.create('col', 'leaflet-routing-instruction-distance',
                  colgroup);
            ...
            createStep: function(text, distance, icon, steps) {
              ...
              span = L.DomUtil.create(
                  'span', 'leaflet-routing-icon leaflet-routing-icon-' + icon,
                  td);
              td.appendChild(span);
              td = L.DomUtil.create('td', '', row);
        ...
        (function() {
          ...
          module.exports = L.Control.extend({
            ...
            options: {
              ...
              collapseBtn: function(itinerary) {
                var collapseBtn = L.DomUtil.create('span',
                    itinerary.options.collapseBtnClass);
                L.DomEvent.on(collapseBtn, 'click', itinerary._toggle,
                    itinerary);
                itinerary._container.insertBefore(collapseBtn,
            ...
            initialize: function(options) {
              L.setOptions(this, options);
              this._formatter = this.options.formatter ||
                  new Formatter(this.options);
              this._itineraryBuilder = this.options.itineraryBuilder ||
            ...
            onAdd: function(map) {
              ...
              this._container = L.DomUtil.create(
                  'div', 'leaflet-routing-container leaflet-bar ' +
                  (!this.options.show ?
              ...
              L.DomEvent.addListener(this._container, 'mousewheel',
                  function(e) {
            ...
            _toggle: function() {
              var collapsed = L.DomUtil.hasClass(this._container,
                  'leaflet-routing-container-hide');
            ...
            _createAlternative: function(alt, i) {
              ...
              altDiv.innerHTML = typeof(template) === 'function' ?
                  template(data) :
            ...
            _createItineraryContainer: function(r) {
              ...
              for (i = 0; i < r.instructions.length; i++) {
                ...
                step = this._itineraryBuilder.createStep(text, distance, icon,
                    steps);
            ...
            _selectAlt: function(e) {
              ...
              if (L.DomUtil.hasClass(altElem,
                      'leaflet-routing-alt-minimized')) {
                for (j = 0; j < this._altElements.length; j++) {
                  n = this._altElements[j];
                  classFn = j === e.route.routesIndex ?
                      'removeClass' :
                      'addClass';
          ...
          typeof self !== 'undefined' ?
              ...
              typeof window !== 'undefined' ?
                  window :
                  {});
    }, {'./formatter': 51, './itinerary-builder': 54}], 56: [
    function(_dereq_, module, exports) {
      (function(global) {
        (function() {
          'use strict';
          ...
          module.exports = L.LayerGroup.extend({
            ...
            _getWaypointIndices: function() {
              if (!this._wpIndices) {
                this._wpIndices = this._route.waypointIndices ||
            ...
            for (var i = 0, l = this._langs.length; i < l; i++) {
              ...
              if (!Localization[this._langs[i]]) {
                if (Localization[generalizedCode]) {
                  ...
                  throw new Error('No localization for language "' +
                      this._langs[i] + '".');
                }
              }
            }
          ...
          module.exports = L.Class.extend({
            ...
            route: function(waypoints, callback, context, options) {
              ...
              if (this.options.requestParameters) {
                url += L.Util.getParamString(this.options.requestParameters,
                    url);
              }
                ...
                if (!timedOut) {
                  if (!err) {
                    try {
                      ...
                      try {
                        return this._routeDone(data, wps, options, callback,
                            context);
                      } catch (ex) {
                        error.status = -3;
                      ...
                      error.status = -2;
                      error.message = 'Error parsing OSRM response: ' +
                          ex.toString();
                    }
                  } else {
            ...
            _routeDone: function(
                response, inputWaypoints, options, callback, context) {
              var alts = [],
                  actualWaypoints,
                  i,
                  route;
              ...
              for (i = 0; i < response.routes.length; i++) {
                ...
                route.properties = {
                  isSimplified: !options || !options.geometryOnly ||
            ...
            _convertRoute: function(responseRoute) {
              ...
              if (this.options.stepToText) {
                ...
                stepToText = L.bind(osrmTextInstructions.compile,
                    osrmTextInstructions, this.options.language);
              }
              ...
              for (i = 0; i < legCount; i++) {
                ...
                for (j = 0; j < leg.steps.length; j++) {
                  ...
                  type = this._maneuverToInstructionType(step.maneuver, i ===
                      legCount - 1);
                  modifier = this._maneuverToModifier(step.maneuver);
                  text = stepToText(step, {legCount: legCount, legIndex: i});

                  if (type) {
                    if ((i == 0 && step.maneuver.type == 'depart') ||
            ...
            _decodePolyline: function(routeGeometry) {
              var cs = polyline.decode(routeGeometry,
            ...
            buildRouteUrl: function(waypoints, options) {
              ...
              return this.options.serviceUrl + '/' + this.options.profile +
                  ...
                  (options.geometryOnly ?
                      (options.simplifyGeometry ? '' : 'overview=full') :
                      'overview=false') +
            ...
            _saveHintData: function(actualWaypoints, waypoints) {
              ...
              for (var i = actualWaypoints.length - 1; i >= 0; i--) {
                ...
                this._hints.locations[this._locationKey(
                    loc)] = actualWaypoints[i].hint;
              }
            },
          });
        })();
        ...
        (function() {
          ...
          module.exports = (L.Layer || L.Class).extend({
            ...
            createGeocoders: function() {
              ...
              if (this.options.addWaypoints) {
                addWpBtn = L.DomUtil.create(
                    'button', 'leaflet-routing-add-waypoint ' +
                    this.options.addButtonClassName, container);
              ...
              if (this.options.reverseWaypoints) {
                reverseBtn = L.DomUtil.create('button',
                    'leaflet-routing-reverse-waypoints', container);
            ...
            _createGeocoder: function(i) {
              var geocoder = this.options.createGeocoderElement(
                  this._waypoints[i], i, this._waypoints.length, this.options);
            ...
            _updateMarkers: function() {
              ...
              for (i = 0; i < this._waypoints.length; i++) {
                if (this._waypoints[i].latLng) {
                  m = this.options.createMarker(i, this._waypoints[i],
            ...
            dragNewWaypoint: function(e) {
              ...
              if (this.options.routeWhileDragging) {
                ...
                this._hookWaypointEvents(this._markers[newWpIndex], newWpIndex,
                    true);
              } else {
            ...
            _dragNewWaypoint: function(newWpIndex, initialLatLng) {
              var wp = new Waypoint(initialLatLng),
                  ...
                  marker = this.options.createMarker(newWpIndex,
                      wp, this._waypoints.length + 1),
                  lines = [],
              ...
              for (i = 0; i < this.options.dragStyles.length; i++) {
                lines.push(
                    L.polyline([prevWp.latLng, initialLatLng, nextWp.latLng],
          ...
          typeof self !== 'undefined' ?
              ...
              typeof window !== 'undefined' ?
                  window :
                  {});
    }, {'./geocoder-element': 52, './waypoint': 61}], 61: [
    function(_dereq_, module, exports) {
      (function(global) {
        (function() {
          'use strict';
